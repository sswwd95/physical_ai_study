...
candidate_df["mean"]=mat.mean(0)
candidate_df["lcb_95"]=mat.mean(0)-1.64*mat.std(0)
out=candidate_df.sort_values("lcb_95",ascending=False).head(25)
print(out.round(4))
out.to_csv(OUTPUT_DIR/"ex293_lcb_selection.csv",index=False,encoding="utf-8-sig")
