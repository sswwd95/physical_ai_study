# 실습 206 — multiclass_logistic

## 1. 학습 목표
다항 Logistic Regression으로 고장 유형을 분류합니다.

## 2. Antigravity용 예제 소스 생성 하네스 프롬프트
```text
다항 Logistic Regression으로 5개 장비 상태를 분류하라.
```

## 3. 실행 명령
```bat
conda activate semi-physical-ai-stage11
python examples\ex206_multiclass_logistic.py
```
...
| 36 | `    ("classifier",LogisticRegression(max_iter=2000,class_weight="balanced",random_state=42))])` | 계산 결과나 설정값을 변수에 저장합니다. |
