...
# x, y, z 좌표를 전달할 수 있는 ROS2 Point 메시지를 불러옵니다.
from geometry_msgs.msg import Point
# 참·거짓 상태를 전달하는 ROS2 Bool 메시지를 불러옵니다.
...
class IntegratedVisionNode(Node):
    ...
    def image_callback(self, msg):
        ...
        try:
            ...
            # detected msg 변수에 이후 처리에 사용할 값을 저장합니다.
            detected_msg = Bool()
            ...
            if detection is not None:
                # point msg 변수에 이후 처리에 사용할 값을 저장합니다.
                point_msg = Point()
    ...
    # detect_blue_target 작업을 반복해서 사용할 수 있도록 함수로 정의합니다.
    def detect_blue_target(self, frame):
        ...
        # detection 변수에 이후 처리에 사용할 값을 저장합니다.
        detection = {
            "center_x": center_x,
            "center_y": center_y,
            "area": area,
