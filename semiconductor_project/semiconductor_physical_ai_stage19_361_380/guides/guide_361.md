...
python examples\ex361_project_directory_validation.py
```
...
| 18 | `required=[` | 계산 결과나 설정값을 변수에 저장합니다. |
| 19 | `    ROOT/"data",` | 시스템 통합 또는 운영 자동화 단계를 수행합니다. |
| 20 | `    ROOT/"config",` | 시스템 통합 또는 운영 자동화 단계를 수행합니다. |
| 21 | `    ROOT/"outputs",` | 시스템 통합 또는 운영 자동화 단계를 수행합니다. |
| 22 | `    ROOT/"logs",` | 시스템 통합 또는 운영 자동화 단계를 수행합니다. |
| 23 | `    ROOT/"models",` | 시스템 통합 또는 운영 자동화 단계를 수행합니다. |
| 24 | `    DATA_FILE,` | 시스템 통합 또는 운영 자동화 단계를 수행합니다. |
| 25 | `    CONFIG_FILE,` | 시스템 통합 또는 운영 자동화 단계를 수행합니다. |
| 26 | `]` | 시스템 통합 또는 운영 자동화 단계를 수행합니다. |
| 27 | `rows=[]` | 계산 결과나 설정값을 변수에 저장합니다. |
| 28 | `for path in required:` | 여러 파일·배치·장비를 반복 처리합니다. |
| 29 | `    rows.append({"path":str(path.relative_to(ROOT)),"exists":path.exists(),"type":"dir" if path.is_dir() else "file"})` | 시스템 통합 또는 운영 자동화 단계를 수행합니다. |
| 30 | `result=pd.DataFrame(rows)` | 계산 결과나 설정값을 변수에 저장합니다. |
| 31 | `print(result)` | 결과를 콘솔에 출력합니다. |
| 32 | `if not result["exists"].all():` | 시스템 통합 또는 운영 자동화 단계를 수행합니다. |
| 33 | `    raise FileNotFoundError("필수 운영 파일 또는 폴더가 없습니다.")` | 시스템 통합 또는 운영 자동화 단계를 수행합니다. |
