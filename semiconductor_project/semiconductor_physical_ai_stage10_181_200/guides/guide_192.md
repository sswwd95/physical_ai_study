...
python examples\ex192_probability_of_zero_defects.py
```
...
| 18 | `print("P(0 defects in 100 wafers):",round(np.mean((1-p_s)**100),5))` | 계산 결과를 콘솔에 출력합니다. |
