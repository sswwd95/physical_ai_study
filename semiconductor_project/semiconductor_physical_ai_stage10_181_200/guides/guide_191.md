...
python examples\ex191_posterior_predictive_defects.py
```
...
| 18 | `pred=np.random.default_rng(42).binomial(100,p_s)` | 계산 결과나 설정값을 변수에 저장합니다. |
| 19 | `print("예측 평균 불량수:",round(pred.mean(),3)); print("94% HDI:",az.hdi(pred,hdi_prob=.94))` | 최고밀도구간을 계산합니다. |
