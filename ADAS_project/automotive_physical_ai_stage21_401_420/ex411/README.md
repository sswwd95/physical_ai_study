...
| 4 | ` v.opt.flags[mj.mjtVisFlag.mjVIS_JOINT]=True; v.opt.flags[mj.mjtVisFlag.mjVIS_ACTUATOR]=True` | Viewer 또는 물리 상태를 설정·실행합니다. |
| 5 | ` run(mj,m,d,v,10,lambda m,d:wheels(d,-5,5))` | Viewer 또는 물리 상태를 설정·실행합니다. |
