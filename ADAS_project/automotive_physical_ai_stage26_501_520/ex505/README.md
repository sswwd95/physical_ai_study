...
| 4 | `    realtime_loop(mujoco,model,data,viewer,12,lambda m,d:set_wheels(d,4.5,4.5))` | 공식 휠 actuator 범위 안에서 좌우 명령을 적용합니다. |
