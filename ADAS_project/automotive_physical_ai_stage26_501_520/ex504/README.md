# 예제 504 — Passive Viewer 기본 물리 루프
...
| 줄 | 소스 | 설명 |
|---:|---|---|
| 1 | `from common.tb3_burger_utils import load_tb3,realtime_loop` | 공식 Burger 모델과 Viewer 실행에 필요한 모듈을 불러옵니다. |
...
| 4 | `    realtime_loop(mujoco,model,data,viewer,10)` | 현재 Burger Viewer 실습 절차를 수행합니다. |
| 5 | `print("simulation time:",data.time)` | 모델 구조, 상태 또는 저장 경로를 출력합니다. |
