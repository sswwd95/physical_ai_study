...
| 4 | `    realtime_loop(mujoco,model,data,viewer,10,lambda m,d:set_wheels(d,-3.5,3.5))` | 공식 휠 actuator 범위 안에서 좌우 명령을 적용합니다. |
