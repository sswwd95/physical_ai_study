...
| 줄 | 소스 | 설명 |
|---:|---|---|
| 1 | `speed_mps=.8` | 상태, 행동, 보상 또는 통계값을 계산합니다. |
| 2 | `dt=.1` | 상태, 행동, 보상 또는 통계값을 계산합니다. |
| 3 | `progress_reward=speed_mps*dt` | 상태, 행동, 보상 또는 통계값을 계산합니다. |
| 4 | `print("progress reward:",progress_reward)` | 환경 상태, 보상 또는 검증 결과를 출력합니다. |
