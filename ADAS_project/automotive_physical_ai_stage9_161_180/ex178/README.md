...
| 6 | `i=sample_model(model); s=az.summary(i,var_names=["bias","sigma"]); p=output_path("ex178_diagnostics.csv"); s.to_csv(p); print(s[["r_hat","ess_bulk","ess_tail"]]); print(p)` | MCMC로 사후분포를 샘플링합니다. |
