...
| 3 | `print(df["true_risk_probability"].describe())` | 추정값, 성능, 판정 또는 저장 경로를 출력합니다. |
| 4 | `print(df.groupby("severity")["true_risk_probability"].agg(["count","mean","min","max"]))` | 추정값, 성능, 판정 또는 저장 경로를 출력합니다. |
