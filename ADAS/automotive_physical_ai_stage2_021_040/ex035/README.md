...
- **04행** `result = df.nsmallest(10, "front_distance_m")` — 센서 값, 조건식 또는 계산 결과를 변수에 저장합니다.
- **05행** `print(result[["time_s", "speed_mps", "front_distance_m", "status"]])` — 계산 결과나 상태를 화면에 출력해 확인합니다.
