...
| 3 | `y = load_data()["yaw_error_rad"].to_numpy()` | 데이터, 모델 모수, 통계량 또는 판정값을 계산합니다. |
...
| 9 | `summary, path = save_summary(idata, ["bias","sigma"], "ex190_yaw_error.csv")` | 데이터, 모델 모수, 통계량 또는 판정값을 계산합니다. |
