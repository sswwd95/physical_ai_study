...
| 6 | `idata=sample_model(model); s,p=save_summary(idata,["bias","sigma"],"ex165_bias_sigma_summary.csv"); print(s); print(p)` | MCMC로 사후분포를 샘플링합니다. |
