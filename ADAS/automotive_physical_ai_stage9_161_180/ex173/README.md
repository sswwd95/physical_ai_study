...
| 6 | `idata=sample_model(model); s,p=save_summary(idata,["intercept","temp_coef","sigma"],"ex173_temperature.csv"); print(s); print(p)` | MCMC로 사후분포를 샘플링합니다. |
