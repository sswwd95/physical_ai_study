...
| 3 | `for x,y in [(2,.8),(2,-.8),(7,.2)]:` | 현재 경로 추종 절차를 실행합니다. |
| 4 | `    idx=nearest_path_index(path,x,y)` | 차량과 가장 가까운 경로점을 찾습니다. |
| 5 | `    print(x,y,signed_cross_track_error(path,idx,x,y))` | 목표점, 오차, 성능 또는 저장 경로를 출력합니다. |
