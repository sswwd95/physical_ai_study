...
| 4 | `x=standardize(df["load_index"]).to_numpy()` | 수명, 생존확률, RUL 또는 평가값을 계산합니다. |
...
| 8 | `    b=pm.Normal("load_coef",0,1)` | 회귀계수 또는 관측오차 모델을 정의합니다. |
...
| 12 | `s,pth=save_summary(idata,["intercept","load_coef","sigma"],"ex291_load_lifetime_regression.csv")` | 수명 또는 RUL 데이터를 읽습니다. |
