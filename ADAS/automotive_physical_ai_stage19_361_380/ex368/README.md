...
| 줄 | 소스 | 설명 |
|---:|---|---|
| 1 | `for lateral_error in [0,.2,.8,1.5,2.4]:` | 현재 강화학습 환경 절차를 실행합니다. |
| 2 | `    penalty=1.5*abs(lateral_error)` | 상태, 행동, 보상 또는 통계값을 계산합니다. |
| 3 | `    print(lateral_error,penalty)` | 환경 상태, 보상 또는 검증 결과를 출력합니다. |
