...
| 줄 | 소스 | 설명 |
|---:|---|---|
| 1 | `from envs.simple_car_env import SimpleCarEnv` | Gymnasium 환경과 분석에 필요한 모듈을 불러옵니다. |
| 2 | `e1=SimpleCarEnv(seed=42); e2=SimpleCarEnv(seed=42)` | 교육용 자동차 강화학습 환경을 생성합니다. |
| 3 | `o1,_=e1.reset(seed=123); o2,_=e2.reset(seed=123)` | 환경을 초기화하고 최초 관측값을 받습니다. |
| 4 | `print(o1); print(o2); print("equal:",(o1==o2).all())` | 환경 상태, 보상 또는 검증 결과를 출력합니다. |
| 5 | `e1.close(); e2.close()` | 현재 강화학습 환경 절차를 실행합니다. |
