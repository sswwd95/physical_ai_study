...
| 2 | `env=SimpleCarEnv(seed=42)` | 교육용 자동차 강화학습 환경을 생성합니다. |
| 3 | `obs,info=env.reset(seed=42)` | 환경을 초기화하고 최초 관측값을 받습니다. |
| 4 | `print("observation:",obs)` | 환경 상태, 보상 또는 검증 결과를 출력합니다. |
| 5 | `print("info:",info)` | 환경 상태, 보상 또는 검증 결과를 출력합니다. |
